...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--width",
                                 ...
                                 default=640)
        self.parser.add_argument("--height_crop",
                                 type=int,
                                 help="height before crop",
                                 default=450)
        self.parser.add_argument("--width_crop",
                                 type=int,
                                 help="width before crop",
                                 default=800)
        ...
        self.parser.add_argument("--learning_rate_pose",
                                 type=float,
                                 help="learning rate of pose net",
                                 default=1e-4)
        self.parser.add_argument("--learning_rate_encoder",
                                 type=float,
                                 help="learning rate of dino encoder",
                                 default=5e-6)
        self.parser.add_argument("--learning_rate_decoder",
                                 type=float,
                                 help="learning rate of DPT decoder",
                                 default=5e-5)
        ...
        self.parser.add_argument("--encoder", default='vitb',type=str)
        
        # denoise
        self.parser.add_argument("--denoise",
                                 default=["universal_denoise","equalize"],
                                 help="denoise",
                                 type=str,
                                 nargs="+")
